...
public abstract class GameApplet extends Applet implements Runnable, KeyListener, MouseListener, MouseMotionListener{
   ...
   //------------------------------------------------------------------------//
	...
	int gameWidth = 2560;
	int gameHeight = 1440;
	Dimension screenSize = new Dimension(gameWidth, gameHeight);
...
//	Rectangle quitButton = new Rectangle(150, 400, 100, 25);
//	Rectangle optionsButton = new Rectangle(150, 600, 100, 25);
   ...
   //------------------------------------------------------------------------//
	...
	//------------------------------------------------------------------------//
	// Constructor to spawn in the menu
   //------------------------------------------------------------------------//
